...
+ [Ya I guess]
    Great! Now... could you find some tools around the ship and clear those obstacles for me so I can set up my tent?
    -> END
+ [Umm not really]
    -> tutorialRecap
...
Now grab those tools and clear those obstacles
-> END