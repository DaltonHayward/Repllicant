...
namespace ReplicantPackage
{
    ...
    /// Provides basic functionality for saving and loading date from our Profile scriptable objects. 
    /// Can work with multiple profiles but we will only be using the first profile atm
    /// NOTE: This works for now but we should implement a proper save system and update or remove this 
    /// </summary>
    public class BaseProfileManager : MonoBehaviour
    {
        ...
        private int numberOfProfileSlots = 3; // arbitrary number
        ...
        public void Init()
        {
            ...
            // if we already have saved profiles on disk, load them.. otherwise create them
